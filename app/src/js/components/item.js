...
var Item = React.createClass({
	...
	onMouseDown: function() { console.log('Item.onMouseDown'); },
	onMouseUp: function() { console.log('Item.onMouseUp'); },
	onMouseEnter: function() { console.log('Item.onMouseEnter'); },
	onMouseLeave: function() { console.log('Item.onMouseLeave'); },*/
